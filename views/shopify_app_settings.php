...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
        <a class="btn btn-primary" href="<?php echo base_url('shopify_integration/add_shopify_settings') ?>"><i class="fas fa-plus-circle"></i> <?php echo $this->lang->line('Connect Shopify API'); ?></a>
    </div>
  ...
  if($this->session->flashdata('error_message_shopify')!='')
  echo "<div class='alert alert-danger text-center'><i class='fa fa-remove'></i> ".$this->session->flashdata('error_message_shopify')."</div>";
  ?>
        ...
        <div class="col-12 col-sm-6">
          <div class="card profile-widget mt-4">
                ...
                <div class="profile-widget-items">
                  <div class="profile-widget-item">
                    <div class="profile-widget-item-value">
                      <a target='_BLANK' href="<?php echo base_url("shopify_integration/store/".$value["id"]);?>"  class='btn btn-outline-info ' data-toggle='tooltip' data-placement='top' title="<?php echo $this->lang->line('Visit Store Webview');?>"><i class='fas fa-eye'></i> <?php echo $this->lang->line('Store Webview');?></a>
                    </div>
                  </div>
                  <div class="profile-widget-item">
                    <div class="profile-widget-item-value">
              ...
              <div class="profile-widget-description" style="padding-bottom: 0;">
                <div class="profile-widget-name text-center"><a href='<?php echo $value["home_url"];?>' target="_BLANK"><i class='fab fa-wordpress'></i> <?php echo $value["home_url"];?></a></div>
                <div class="profile-widget-name text-center">
                  <small  data-toggle='tooltip' data-placement='top' title="<?php echo $this->lang->line('Consumer Key');?>"><i class='fas fa-key'></i> <?php echo (!$this->is_demo) ? $value["access_token"]:"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";?></small><br>
              ...
              <div class="profile-widget-header">
                <div class="profile-widget-items">
                  ...
                  <div class="profile-widget-item">
                    <div class="profile-widget-item-value">
                       <a href="<?php echo base_url('shopify_integration/edit_shopify_settings/').$value['id'];?>" class='mt-2 btn btn-outline-primary' data-toggle='tooltip' data-placement='top' title="<?php echo $this->lang->line('Update');?>" ><i class='fas fa-edit'></i> <?php echo $this->lang->line('Update');?></a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="card">
          <div class="card-body">
            <div class="empty-state" data-height="400" style="height: 400px;">
              ...
              <h2><?php echo $this->lang->line("No Shopify Integration found."); ?></h2>
              <p>&nbsp;</p>
              <a class="btn btn-primary" href="<?php echo base_url('shopify_integration/add_shopify_settings') ?>"><i class="fas fa-plus-circle"></i> <?php echo $this->lang->line('Connect Shopify API');?></a>
            </div>
          </div>
...
<script>       
  ...
  $(document).ready(function() {
    ...
    $(document).on('click','.show_product',function(e){
      ...
      $("#show_products_modal iframe").attr('src',base_url+'shopify_integration/product_list/'+id);
    });
    ...
    $(document).on('click','.copy_url',function(e){
      ...
      $("#copy_url_modal iframe").attr('src',base_url+'shopify_integration/copy_url/'+id);
    });
      ...
      .then((willDelete) => {
        if (willDelete) 
        {
          ...
          $.ajax({
            context: this,
            type:'POST' ,
            url:"<?php echo site_url();?>shopify_integration/delete_action",
            dataType: 'json',
